<div>
    ...
    <x-dialog-modal wire:model='modalCrear'>
        ...
        <x-slot name="content">
            ...
            {{-- IMAGEN --}}
            <div class="mb-4">
                <label for="imagenC" class="block text-sm font-medium text-gray-700">Imagen del post</label>
                <div class="relative w-full h-96 ">
                    ...
                    <div class="bg-gray-200 h-full w-full rounded-md flex justify-center items-center">
                        @if ($imagen)
                            <img src="{{ $imagen->temporaryUrl() }}" alt="Imagen del post" class="h-full w-full">
                        @else
